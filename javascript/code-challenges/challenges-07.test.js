...
const listFoods = (recipe) => {
  let result = [];
  result.push(recipe.ingredients[0].slice(-8));
  result.push(recipe.ingredients[1].slice(-4));
  result.push(recipe.ingredients[2].slice(-11));
  result.push(recipe.ingredients[3].slice(-5));
  result.push(recipe.ingredients[4].slice(-16));
  result.push(recipe.ingredients[5].slice(-12));
  result.push(recipe.ingredients[6].slice(-11));
  result.push(recipe.ingredients[7].slice(-13));
  result.push(recipe.ingredients[8].slice(-8));
  result.push(recipe.ingredients[9].slice(-13));
  result.push(recipe.ingredients[10].slice(-11));
  return result;
};
